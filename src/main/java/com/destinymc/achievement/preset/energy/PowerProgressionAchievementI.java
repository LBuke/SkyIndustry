...
public final class PowerProgressionAchievementI extends BaseAchievement {
     ...
     */
    public PowerProgressionAchievementI() {
        super(
                3, //Unique Identifier
                "power-progression-i", //Name to reference in i18n properties
    ...
    protected final void onMachinePlace(MachinePlaceEvent event) {
        if (!(event.getMachine() instanceof MachineBatBox))
            return;
