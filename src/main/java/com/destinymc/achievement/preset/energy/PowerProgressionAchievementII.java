...
public final class PowerProgressionAchievementII extends BaseAchievement {
     ...
     */
    public PowerProgressionAchievementII() {
        super(
                4, //Unique Identifier
                "power-progression-ii", //Name to reference in i18n properties
    ...
    protected final void onMachinePlace(MachinePlaceEvent event) {
        if (!(event.getMachine() instanceof MachineMFE))
            return;
