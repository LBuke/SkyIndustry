 ...
 * @author Luke Bingham
 */
public final class MachineMFS extends BaseMachine implements PoweredMachine {
    ...
    public MachineMFS(long identifier, Location location, MachinePowerData powerData) {
        super(
                identifier,
                location,
                "MFS",
                new String[]{
                        ...
                        " ",
                        C.WHITE + "Power tier: 4 (Max I/O 512 EU/t)",
                        C.WHITE + "Capacity: 10M EU",
                        " "
                },
                4,
                3,
        ...
        powerData.setIntake(512);
        powerData.setOuttake(512);
        powerData.setInputSlot(21);
        powerData.setOutputSlot(3);
        powerData.setMaximumCapacity(10000000);
