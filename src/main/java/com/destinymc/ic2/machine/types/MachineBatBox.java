 ...
 * @author Luke Bingham
 */
public final class MachineBatBox extends BaseMachine implements PoweredMachine {
    ...
    public MachineBatBox(long identifier, Location location, MachinePowerData powerData) {
        super(
                identifier,
                location,
                "BatBox",
                new String[]{
                        ...
                        " ",
                        C.WHITE + "Power tier: 1 (Max I/O 32 EU/t)",
                        C.WHITE + "Capacity: 40K EU",
                        " "
                },
                4,
                1,
        ...
        powerData.setOuttake(32);
        powerData.setInputSlot(21);
        powerData.setOutputSlot(3);
        powerData.setMaximumCapacity(40000);
