...
public class ChunkPacketProcessor {
    /**
     * Contains the offset of the different block profile in a chunk packet.
     *
     * @author Kristian
     */
    public static class ChunkOffsets {
        ...
        /**
         * Retrieve the starting index of the block ID profile.
         * <p>
         * This will be 4096 bytes in lenght, one byte for each block in the
         * 16x16x16 chunklet.
         *
         * @return The starting location of the block ID profile.
         */
        ...
        /**
         * Retrieve the starting index of the meta profile (4 bit per block).
         * <p>
         * This will be 2048 bytes in lenght, one nibblet for each block in the
         * 16x16x16 chunklet.
         *
         * @return The starting location of the block meta profile.
         */
        ...
        /**
         * Retrieve the starting index of the torch light profile (4 bit per
         * block).
         * <p>
         * This will be 2048 bytes in lenght, one nibblet for each block in the
         * 16x16x16 chunklet.
         *
         * @return The starting location of the torch light profile.
         */
        ...
        /**
         * Retrieve the starting index of the skylight profile (4 bit per block).
         * <p>
         * This will be 2048 bytes in lenght if the skylight profile exists (see
         * {@link #hasSkylightOffset()}), no bytes if not.
         *
         * @return The starting location of the skylight profile.
         */
        ...
        /**
         * Determine if the current chunklet contains skylight profile.
         *
         ...
         * <p>
         * This will be 2048 bytes in lenght if the extra profile exists, no bytes
         * if not.
         *
         * @return The starting location of the extra profile.
         */
        ...
        /**
         * Determine if the current chunklet contains any extra block ID profile.
         *
         * @return TRUE if it does, FALSE otherwise.
         */
    ...
    /**
     * ProcessMachine the content of a single 16x16x16 chunklet in a 16x256x16 chunk.
     *
     * @author Kristian
     */
    public interface ChunkletProcessor {
        /**
         * ProcessMachine a given chunklet (16x16x16).
         *
         * @param origin  - the block with the lowest x, y and z coordinate in
         *                the chunklet.
         * @param data    - the profile array.
         * @param offsets - the offsets with the profile for the given chunklet.
         */
        public void processChunklet(Location origin, byte[] data,
                                    ChunkOffsets offsets);

        /**
         * ProcessMachine the biome array for a chunk (16x256x16).
         * <p>
         ...
         *                   the chunk.
         * @param data       - the profile array.
         * @param biomeIndex - the starting index of the biome profile (256 bytes
         *                   in lenght).
         */
     ...
     * processor.profile = byteArrays.read(1); //packet.buildBuffer;
     * // Check for Spigot
     * if (processor.profile == null || processor.profile.length == 0) {
     * processor.profile =
    ...
    public void process(ChunkletProcessor processor) {
        ...
        // amount of bytes per block. This last figure can be calculated by adding together all the profile parts:
        //   For any block:
        ...
        //   If the segment has extra profile:
