...
public final class ChatComponent {
    ...
    public void addClickEvent(String pText, ClickEvent event, ChatColor... color) {
        ...
        if (!(event instanceof ClickEvent)) {
            event = new ClickEvent(action, "https://google.com");
        }
    ...
    public void addHoverEvent(String pText, HoverEvent event, ChatColor... color) {
        ...
        if (!(event instanceof HoverEvent)) {
            event = new HoverEvent(action, new ComponentBuilder(C.WHITE + "Component" + C.BOLD + "API").create());
        }
